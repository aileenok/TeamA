...
params.dt = 0.10;                  % [s]
params.horizon = 10.0;             % [s]
params.laneChangeTime = 3.0;       % [s]
params.speedTransitionTime = 3.0;  % [s]
...
params.costTimeTargetDistance = 300.0;      % [m]
params.costFutureLookAheadTime = 2.0;       % [s]
